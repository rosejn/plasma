...
;
;Cerebrum - divided into two hemispheres (left and right), each consists of four lobes (frontal, parietal , occipital  and temporal). The outer layer of the brain is known as the cerebral cortex    or the ‘grey matter’. It covers the nuclei deep within the cerebral hemisphere known as the ‘white matter’.
;
...
;
;The thalamus and hypothalamus are prominent internal structures. The thalamus has wide-ranging connections with the cortex and many other parts of the brain, such as the basal ganglia, hypothalmus and brainstem. It is capable of perceiving pain but not at accurately locating it. The hypothalamus has several important functions, including control of the body’s appetite, sleep patterns, sexual drive and response to anxiety.
;
;Ventricles
;
...
;Limbic System
;
;The limbic system is not a structure, but a series of nerve pathways incorporating structures deep within the temporal lobes, such as the hippocampus  and the amygdale. Forming connections with the cerebral cortex, white matter and brainstem, the limbic system is involved in the control and expression of mood and emotion, in the processing and storage of recent memory, and in the control of appetite and emotional responses to food. All these functions are frequently affected in depression and the limbic system has been implicated in the pathogenesis of depression. The limbic system is also linked with parts of the neuroendocrine and autonomic nervous systems, and some neurological disorders, such as anxiety, are associated with both hormonal and autonomic changes.
;
